...
uses custom srid 1000004 and custom coordinate operation id 1000004 as defaults.  Alter them if needed.

*/

DECLARE
   -- Adjust the following two values as neeeded
   int_custom_srid INTEGER := 1000004;
   int_custom_opid INTEGER := 1000004;
   -- 
BEGIN
   ...
   INSERT INTO MDSYS.SDO_COORD_REF_SYSTEM(
      ...
      ,'DZ'
      ,'TRUE'
      ,'PROJCS["NAD83 Puerto Rico/Virgin Islands Albers Equal Area USGS",GEOGCS["NAD 83",DATUM["NAD 83",SPHEROID["GRS 80",6378137,298.2572221010002]],PRIMEM["Greenwich",0],UNIT["Decimal Degree",0.0174532925199433]],PROJECTION["Albers Conical Equal Area"],PARAMETER["False_Easting",0.0],PARAMETER["False_Northing",0.0],PARAMETER["Central_Meridian",-66.0],PARAMETER["Standard_Parallel_1",8],PARAMETER["Standard_Parallel_2",18],PARAMETER["Latitude_Of_Origin",3.0],UNIT["Meter",1.0]]'
      ,'TRUE'
      ,'TRUE'
   );
   -- Done
