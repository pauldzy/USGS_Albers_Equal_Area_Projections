...
You already should have this projection as SDO_SRID 3338 on your instance.

Otherwise paste this script into Oracle and adjust the custom identifiers as needed for your system.  This script 
uses custom srid 1000003 and custom coordinate operation id 1000003 as defaults.  Alter them if needed.

*/

DECLARE
   -- Adjust the following two values as neeeded
   int_custom_srid INTEGER := 1000003;
   int_custom_opid INTEGER := 1000003;
   -- 
BEGIN
